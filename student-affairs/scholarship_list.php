<?php
    ...
    $active = true;
    $result = $scholarship->readall($active);
...
<head>
	...
	<title>ทุนการศึกษา | FMS Student Portal</title>
	<!-- Custom CSS -->
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ทุนการศึกษา</h4>
                    </div>
            ...
            <!-- ============================================================== -->
                ...
                <div class="page-content container-fluid">
                    ...
                    <?php while ($row = mysqli_fetch_array($result)) { ?>
                        <div class="col-md-6 single-note-item">
                            <div class="card border-info">
                                <div class="card-header bg-info">
                                    <?php 
                                        $stype->scholarship_type_id = $row['scholarship_type_id'];
                                        $result_stype = $stype->readone();
                                        $row_stype = mysqli_fetch_array($result_stype);
                                    ?>
                                    <h5 class="mb-0 text-white">
                                        <?php echo $row_stype['scholarship_type_name']; ?>
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <span class="side-stick bg-warning"></span>
                                    <!-- <h3 class="card-title">This card has width of 50%</h3> -->
                                    <span><i class="ti-calendar"></i> <?php echo $scholarship->DateThai($row['scholarship_date']); ?></span>
                                    <h4 class="font-medium font-16 mb-2 mt-2"><u><?php echo $row['scholarship_name']; ?></u></h4>
                                    <p class="card-text" data-todosubtext-html="<?php echo ""; ?>"><?php echo substr(htmlspecialchars(trim(strip_tags($row['scholarship_desc']))), 0, 500); ?></p>
                                    <a href="#" class="btn btn-secondary btn-rounded" data-toggle="modal" data-target="#showDescModal" data-id="<?php echo $row['scholarship_id']; ?>" id="btn-desc">รายละเอียด</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">รายละเอียดทุนการศึกษา</h5>
