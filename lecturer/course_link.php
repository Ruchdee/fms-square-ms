<?php
    ...
    $section_lect->lecturer_id = $_SESSION['lecturer_id_card'];
    $result_sect = $section_lect->readone(); 
                                    ...
                                    <table id="alt_pagination" class="table table-striped display" style="width:100%">
                                        ...
                                        <?php while ($row_sect = mysqli_fetch_array($result_sect)) { ?>
                                            <?php
                                                ...
                                                $result_link = $course_link->readone();
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $row_course['course_credit']; ?></td>
                                                <td class="text-center">
                                                    <a href="#" class="text-primary" data-toggle="modal" data-target="#linkModal" data-id="<?php echo $row_course['section_offer_id']; ?>" id="btn-link">
                ...
                <div class="modal fade" id="linkModal" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <form id="form-update" method="post" action="course_link_op.php">
