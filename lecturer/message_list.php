<?php
    ...
    $_SESSION['profile_img'] = $_SESSION['lecturer_img'];
...
<head>
    ...
    <title>ข้อความ-อาจารย์ | FMS Student Portal</title>
    <!-- Custom CSS -->
    <!-- Popup CSS -->
...
<body>
                                        ...
                                        <div class="col-md-12">
                                            <div class="contact-name">
                                                <select class="form-control custom-select mr-sm-2" id="select-student" name="scholarship-type-status"  onchange="selectedCheck(this);" required>
                                                    ...
                                                    <?php if (isset($_SESSION['admin_id']) or isset($_SESSION['lecturer_ppid'])) {?>
    ...
    <script src="../dist/js/pages/chat/chat.js" url="lec_message_list_op.php"></script>
