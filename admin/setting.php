<?php
    ...
    //check session - admin id, name, e-mail
...
<head>
    ...
    <title>การตั้งค่า-ผู้ดูแลระบบ | FMS Student Portal</title>
    <!-- Custom CSS -->
    <!-- Popup CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">การตั้งค่า</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form class="form-horizontal" action="setting_op.php?action=u" method="post">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="fname2" class="col-sm-3 text-right control-label col-form-label">ปีการศึกษา</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="academic-year" name="academic-year" placeholder="Academic Year" required value="<?php echo $row['academic_year']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="lname2" class="col-sm-3 text-right control-label col-form-label">ภาคการศึกษา</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="semester" name="semester" placeholder="Semester" required value="<?php echo $row['semester']; ?>">
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-0 text-right">
                                        ...
                                        <button type="reset" class="btn btn-dark waves-effect waves-light">ยกเลิก</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php
    if (isset($_GET['msg']) && $_GET['msg']=='success') {
        echo "<script>toastr.success('บันทึกข้อมูลเรียบร้อยแล้ว', 'การตั้งค่า');</script>";
    }
?>