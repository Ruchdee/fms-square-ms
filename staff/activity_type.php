<?php
    ...
    //read all records
    $active = false;
    $result = $stype->act_readall($active);
                    ...
                    <div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                               ...
                               <form method="post" action="activity_type_op.php?action=i">
                    ...
                    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form method="post" action="activity_type_op.php?action=u">
                                    <div class="modal-body">
        ...
        $(document).ready(function(){	
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "activity_type_op.php?action=d&activity_type_id=" + stype_id);
                        Swal.fire(
                            'Deleted!',
