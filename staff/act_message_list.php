...
<body>
                        ...
                        <div class="modal-body pb-0">
                            <div class="add-contact-box">
                                <div class="add-contact-content">
                                    ...
                                    <form method="post" action="act_message_list_op.php">
                                    ...
                                    <form method="post" action="act_message_list_op.php">
                                        <div id="selected-group" style="display:none;">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <label for="msg_text">ข้อความ</label>
                                                    <textarea name="g_msg_text" id="g_msg_text" cols="30" rows="3" class="form-control" placeholder="ข้อความข้อความไม่เกิน 200 ตัวอักษร" maxlength="200" required></textarea>
    ...
    <script src="../dist/js/pages/chat/chat.js" url="act_message_list_op.php"></script>
