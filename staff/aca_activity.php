<?php
    ...
    $active_stype = true;
    $result_stype = $stype->aca_readall($active_stype);
    $result_stype_add = $stype->aca_readall($active_stype);

    //read all records from activity table
    $active = false;
    $result = $activity->aca_readall($active);
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                            ...
                            <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="form-update" method="post" action="aca_activity_op.php?action=u">
            ...
            <div class="modal fade" id="addActivityModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content border-0">
                        <form id="form-add" class="form-horizontal" method="post" action="aca_activity_op.php?action=i">
                            <div class="modal-header bg-info text-white">
    ...
    <script>
        $(document).ready(function(){	
            ...
            $(document).on('click', '#btn-list', function(e){
                ...
                $.ajax({
                    url: 'aca_activity_register_list.php',
                    type: 'POST',
                    data: 'activity_id='+activity_id,
                    dataType: 'html'
                })
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_activity_op.php?action=d&activity_id=" + activity_id);
                        Swal.fire(
                            'Deleted!',
