<?php 
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'i') {
        ...
        //insert
        if ($calendar->create()) {
            header("Location: aca_calendar.php?msg=success");
        } else {
            header("Location: aca_calendar.php?msg=insert-error");
        }
    }
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'u') {
        ...
        if ($calendar->update()) {
            ...
            header("Location: aca_calendar.php?msg=update-error");
        }
    }
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'd') {
        if (isset($_GET['calendar_id'])) {
            ...
            if ($calendar->delete()) {
                ...
                header("Location: aca_calendar.php?msg=delete-error");
            }
        }
    }
