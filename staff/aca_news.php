<?php
    ...
    //check session - staff id, name, e-mail, academic year, semester
    ...
    $active = false;
    $news->news_owner = "E";
    $result = $news->readallforunit($active);
...
<head>
    ...
    <title>ข่าวสารและประกาศ-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
            ...
            <div class="email-app todo-box-container">
	            ...
	            <div class="left-part list-of-tasks">
	                ...
	                <div class="scrollable" style="height:100%;">
	                    <div class="p-3">
	                        <a class="waves-effect waves-light btn btn-info d-block" href="javascript:void(0)" id="add-news">เพิ่มข้อมูล</a>
	                    </div>
	                    ...
	                    <ul class="list-group">
	                        ...
	                        <li class="list-group-item">
	                            <a href="javascript:void(0)" class="todo-link list-group-item-action" id="current-news"> <i class="mdi mdi-forum"></i> ข่าวสาร <span class="todo-badge badge badge-warning float-right"></span></a>
	                        </li>
	                        <li class="list-group-item">
	                            <a href="javascript:void(0)" class="todo-link list-group-item-action" id="current-notification"> <i class="mdi mdi-tag"></i> ประกาศ <span class="todo-badge badge badge-success float-right"></span></a>
                            </li>
	                        <li class="list-group-item">
	                            <hr>
	                        </li>
                                ...
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <?php 
                                        if ($row['news_type'] == 1) {
                                            ...
                                            $itype = 'mdi-forum';             //icon type
                                        } else {
                                            $ntype = 'current-notification';        //news type
                                            $itype = 'mdi-tag';             //icon type
                                        }
                                        if ($row['news_status']) {
                                    ...
                                    ?>
                                    <div class="todo-item all-news-list p-3 border-bottom position-relative <?php echo $ntype; ?>">
                                        <div class="inner-item d-flex align-items-start">
                                            <div class="w-100">
                                                <div class="custom-control d-flex align-items-start">
                                                    <div>
                                                        <div class="content-todo">
                                                            <h5 class="font-medium font-16 todo-header mb-0" data-todo-header="<?php echo $row['news_title']; ?>"><?php echo $row['news_title']; ?> <i class="mdi <?php echo $itype; ?>"></i> <i class="mdi <?php echo $istatus; ?>"></i></h5>
                                                            <div class="todo-subtext text-muted" 
                                                                data-todosubtext-html="<?php echo substr(htmlspecialchars(trim(strip_tags($row['news_desc']))), 0, 500); ?>" data-todosubtextText="">
                                                                <?php 
                                                                    //echo trim($row['news_desc']);
                                                                    if (strlen(trim($row['news_desc'])) > 500) {
                                                                        echo substr(htmlspecialchars(trim(strip_tags($row['news_desc']))), 0, 500) . "...";
                                                                    } else {
                                                                        echo trim($row['news_desc']);
                                                                    }
                                                                ?>
                                                            </div>
                                                            <span class="todo-time font-14 text-muted"><i class="icon-calender mr-1"></i><?php echo $row['news_date']; ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-auto">
                                                        <div class="dropdown-action">
                                                            <div class="dropdown todo-action-dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="more-action-1">
                                                                    <a class="edit dropdown-item" href="#" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['news_id']; ?>" id="btn-update"><i class="fas fa-edit text-info mr-1"></i> แก้ไข</a>
                                                                    <a class="remove dropdown-item" href="#" data-id="<?php echo $row['news_id']; ?>" id="btn-delete"><i class="far fa-trash-alt text-danger mr-1"></i> ลบ</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info text-white">
                                            <h5 class="modal-title">แก้ไข-ข่าวสารและประกาศ</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form id="form-update" method="post" action="aca_news_op.php?action=u">
                ...
                <!-- Modal -->
                <div class="modal fade" id="addNewsModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content border-0">
                        <form id="form-add" class="form-horizontal" method="post" action="aca_news_op.php?action=i">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">เพิ่มข่าวสาร & ประกาศ</h5>
                                ...
                                <div class="compose-box">
                                    <div class="compose-content" id="addTaskModalTitle">
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <select class="form-control" name="news-type" required>
                                                    <option value="1" selected>ข่าวสาร</option>
                                                    <option value="2">ประกาศ</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="date" class="form-control" id="news-date" name="news-date" required><span class="validation-text"></span>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="d-flex mail-to mb-4">
                                                    <div class="w-100">
                                                        <input id="news-title" name="news-title" type="text" placeholder="ชื่อเรื่อง" class="form-control" required maxlength="100">
                                        ...
                                        <div class="d-flex mail-subject mb-4">
                                            <div class="w-100">
                                                <div id="newsdescription" class=""></div>
                                                <textarea id="news-desc" name="news-desc" style="display:none"></textarea>
                                                <span class="validation-text"></span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function(){	
            $(document).on('click', '#btn-update', function(e){
                e.preventDefault();
                var news_id = $(this).data('id');   // it will get id of clicked row
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_news_op.php?action=d&news_id=" + news_id);
                        Swal.fire(
                            'Deleted!',
