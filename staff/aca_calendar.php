<?php
    ...
    //check session - staff id, name, e-mail, 
...
<head>
    ...
    <title>ปฏิทินการศึกษา-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ปฏิทินการศึกษา</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
            ...
            <div class="page-content container-fluid">
                ...
                <div class="card card-body">
                    <div class="row">
                        ...
                        <!-- <div class="col-md-8 text-right d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                            <a href="javascript:void(0)" id="btn-add-contact" class="btn btn-info"><i class="mdi mdi-view-list font-16 mr-1"></i>กิจกรรมทั้งหมด</a>
                        </div> -->
                ...
                <div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form class="form-horizontal" method="POST" action="aca_calendar_op.php?action=i">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title" id="myModalLabel">เพิ่มปฏิทินการศึกษา</h5>
                ...
                <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="ModalEditLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form class="form-horizontal" method="POST" action="aca_calendar_op.php?action=u">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title" id="ModalEditLabel">แก้ไขปฏิทินการศึกษา</h5>
                                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                    ...
                                    <div class="compose-box">
                                        <div class="compose-content" id="addTaskModalTitle">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="start" class="control-label">เวลา</label>
                                                    <input type="time" id="start-time-edit" name="start-time-edit" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="start" class="control-label">เวลา</label>
                                                    <input type="time" id="end-time-edit" name="end-time-edit" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
		$(document).ready(function () {
			...
			function edit(event) {
                ...
                $.ajax({
					url: 'aca_calendar_op.php?action=ud',
					type: 'POST',
                    data: { Event: Event },
                    dataType: 'html',
					success: function (rep) {
						if (rep == 'success') {
                            toastr.success('บันทึกข้อมูลเรียบร้อยแล้ว', 'ปฏิทินการศึกษา');
						} else {
                            toastr.error('แก้ไขข้อมูลผิดพลาด', 'ปฏิทินการศึกษา');
						}
					}
				});
			}
        ...
        $(document).on('click', '#btn-delete', function(e){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $(location).attr("href", "aca_calendar_op.php?action=d&calendar_id=" + calendar_id);
                    Swal.fire(
                        'Deleted!',
...
<?php
    if (isset($_GET['msg'])) {
        switch ($_GET['msg']) {
            case 'success':
                echo "<script>toastr.success('บันทึกข้อมูลเรียบร้อยแล้ว', 'ปฏิทินการศึกษา');</script>";
                break;
            case 'insert-error':
                echo "<script>toastr.error('เพิ่มข้อมูลผิดพลาด', 'ปฏิทินการศึกษา');</script>";
                break;
            case 'update-error':
                echo "<script>toastr.error('แก้ไขข้อมูลผิดพลาด', 'ปฏิทินการศึกษา');</script>";
                break;
            case 'delete-error': 
                echo "<script>toastr.error('ลบข้อมูลผิดพลาด', 'ปฏิทินการศึกษา');</script>";
                break;
        }
    }
?>