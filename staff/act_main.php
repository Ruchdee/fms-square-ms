            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">กิจการนักศึกษา (Student Affairs)</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
            ...
            <div class="page-content container-fluid">
                <div class="row el-element-overlay">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/main_news.jpg" alt="News & Announcement" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="act_news.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/scholarship.jpg" alt="Scholarship" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="scholarship.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/activity_calendar.jpg" alt="Calendar" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="act_calendar.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                    <h4 class="mb-0">Activity Calendar</h4> <span class="text-muted">ปฏิทินกิจกรรม</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/main_message.jpg" alt="Notification" />
                                    ...
                                    <!-- <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="act_message_list.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div> -->
                                </div>
                                <div class="el-card-content">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/activity_info.jpg" alt="Activity Info" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="activity.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/student_life.jpg" alt="Student Life" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="university_life.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
