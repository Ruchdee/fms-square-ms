...
<head>
    ...
    <title>ประเภททุนการศึกษา-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ประเภททุนการศึกษา</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                ...
                <div class="widget-content searchable-container list">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title">ประเภททุนการศึกษา</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form method="post" action="scholarship_type_op.php?action=i">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-12">
                                                        <div class="contact-name">
                                                            <input type="text" id="scholarship-type-name" name="scholarship-type-name" class="form-control" placeholder="ประเภททุนการศึกษา" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="contact-occupation">
                                                            <textarea id="scholarship-type-desc" name="scholarship-type-desc" class="form-control" rows="3" placeholder="คำอธิบาย"></textarea>
                                                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped search-table v-middle">
                                <thead class="header-item">
                                    <th class="text-dark font-weight-bold">ประเภททุนการศึกษา</th>
                                    ...
                                    <tr class="search-items">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="ml-2">
                                                    <div class="user-meta-info">
                                                        <span class="user-work" data-occupation="Web Developer"><?php echo $row['scholarship_type_name']; ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="usr-email-addr" data-email="adams@mail.com"><?php echo $row['scholarship_type_desc']; ?></span>
                                        </td>
                                        <td>
                                            <span class="usr-location" data-location="Boston, USA">
                                                <?php if ($row['scholarship_type_status']) {
                                                        echo "ใช้งาน";
                                                    } else { echo "ยกเลิก"; } 
                                                ?>
                                            </span>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btn">
                                                <a href="#" class="text-info" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['scholarship_type_id']; ?>" id="btn-update"><i class="mdi mdi-table-edit font-20"></i></a>
                                                <a href="#" class="text-danger ml-2" data-id="<?php echo $row['scholarship_type_id']; ?>" id="btn-delete"><i class="mdi mdi-delete font-20"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <!-- /.row -->
                    ...
                    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title">แก้ไข-ประเภททุนการศึกษา</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form method="post" action="scholarship_type_op.php?action=u">
                                    <div class="modal-body">
    ...
    <script>
        $(document).ready(function(){	
            $(document).on('click', '#btn-update', function(e){
                ...
                $.ajax({
                    url: 'scholarship_type_update.php',
                    type: 'POST',
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "scholarship_type_op.php?action=d&scholarship_type_id=" + stype_id);
                        Swal.fire(
                            'Deleted!',
