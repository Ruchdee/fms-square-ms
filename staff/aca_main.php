...
<head>
    ...
    <title>เมนูหลัก-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
    <!-- Popup CSS -->
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">บริการการศึกษา (Educational Services)</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
            ...
            <div class="page-content container-fluid">
                <div class="row el-element-overlay">
                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/main_news.jpg" alt="News & Announcement" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="aca_news.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/main_calendar.jpg" alt="Calendar" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="aca_calendar.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                    <h4 class="mb-0">Academic Calendar</h4> <span class="text-muted">ปฏิทินการศึกษา</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/main_message.jpg" alt="Notification" />
                                    <!-- <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="aca_message_list.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div> -->
                                </div>
                                <div class="el-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/activity_info.jpg" alt="Activity Info" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="aca_activity.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/download_upload.jpg" alt="Forms" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="form_submit_list.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                    <h4 class="mb-0">Forms</h4> <span class="text-muted">จัดการแบบฟอร์มเอกสาร</span>
                                </div>
                            </div>
                        </div>
                    </div>    
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/main_online_advisor.jpg" alt="Online Registration Survey" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="aca_course_survey.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/register_moreless.png" alt="Register More/Less Credits" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="aca_register_moreless.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/course_link.png" alt="Register More/Less Credits" />
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="aca_course_link.php"><i class="icon-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
