<?php
    ...
    $_SESSION['profile_img'] = $_SESSION['staff_img'];
...
<head>
    ...
    <title>ข้อความ-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
    <!-- Popup CSS -->
...
<body>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                ...
                                <span class="badge badge-warning badge-pill ml-auto mr-3 font-medium px-2 py-1">4</span>
                            </a>
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ข้อความ (Notification)</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        ...
                        <div class="modal-body pb-0">
                            <div class="add-contact-box">
                                <div class="add-contact-content">
                                        ...
                                        <div class="col-md-12">
                                            <div class="contact-name">
                                                <select class="form-control custom-select mr-sm-2" id="select-student" name="scholarship-type-status" required>
                                                    ...
                                                    <?php if (isset($_SESSION['admin_id']) or isset($_SESSION['staff_id'])) {?>
                                    ...
                                    <form method="post" action="aca_message_list_op.php">
                                        <div id="selected-a-student" style="display:none;">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea name="msg_text" id="msg_text" cols="30" rows="3" class="form-control" placeholder="ข้อความไม่เกิน 200 ตัวอักษร" maxlength="200" required></textarea>
                                                    <button type="submit" name="p_search" class="btn btn-primary form-control" onClick="this.innerText='Sending…';">ส่งข้อความ</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <form method="post" action="aca_message_list_op.php">
                                        <div id="selected-group" style="display:none;">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <label for="msg_text">ข้อความ</label>
                                                    <textarea name="g_msg_text" id="g_msg_text" cols="30" rows="3" class="form-control" placeholder="ข้อความไม่เกิน 200 ตัวอักษร" maxlength="200" required></textarea>
                                                    <button type="submit" name="g_search" class="btn btn-primary form-control" onClick="this.innerText='Sending…';">ส่งข้อความ</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    <script src="../dist/js/pages/chat/chat.js" url="aca_message_list_op.php"></script>
    <!-- script show selected option -->
    <script>
