<?php 
    ...
    if(isset($_POST['send_chk_student'])){
        ...
        header("location: act_message_list.php?msg=success");
        exit;
    }
    ...
    if(isset($_POST['g_search'])){
        ...
        $mlist->semester = $row_setting['semester'];
        $mlist->group_chat_message();
        header('Location: act_message_list.php');
        exit;
    }
    ...
    if(isset($_POST['p_search'])){
        ...
        if($mlist->check_user()){
            ...
            if ($mlist->chat_message()) {
                ...
                header('Location: act_message_list.php?msg=insert-error');
            }
        } else {
            header('Location: act_message_list.php?msg=error');
        }
    }
