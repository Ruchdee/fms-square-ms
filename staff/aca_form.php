...
<head>
    ...
    <title>จัดการแบบฟอร์ม-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
...
<body>
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">จัดการแบบฟอร์ม</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
            ...
            <div class="email-app todo-box-container">
	            ...
	            <div class="left-part list-of-tasks">
	                ...
	                <div class="scrollable" style="height:100%;">
	                    ...
	                    <ul class="list-group">
	                        <li>
	                            <small class="p-3 grey-text text-lighten-1 db">ประเภทฟอร์ม</small>
	                        </li>
	                    ...
	                    <div class="todo-listing">
                            ...
                            <?php if (mysqli_num_rows($result) > 0) { ?>
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    ...
                                    ?>
                                    <div class="todo-item all-news-list p-3 border-bottom position-relative <?php echo $row['form_id']; ?>">
                                        <div class="inner-item d-flex align-items-start">
                                            <div class="w-100">
                                                <div class="custom-control d-flex align-items-start">
                                                    <div>
                                                        <div class="content-todo">
                                                            <h5 class="font-medium font-16 todo-header mb-0" data-todo-header="<?php echo $row['form_name']; ?>"><?php echo $row['form_name']; ?> <i class="mdi <?php echo $istatus; ?>"></i></h5>
                                                            <div class="todo-subtext text-muted" 
                                                                data-todosubtext-html="<?php echo substr(htmlspecialchars(trim(strip_tags($row['form_desc']))), 0, 500); ?>" data-todosubtextText="">
                                                                <?php 
                                                                    //echo trim($row['news_desc']);
                                                                    if (strlen(trim($row['form_desc'])) > 500) {
                                                                        echo substr(htmlspecialchars(trim(strip_tags($row['form_desc']))), 0, 500) . "...";
                                                                    } else {
                                                                        echo trim($row['form_desc']);
                                                                    }
                                                                ?>
                                                            </div>
                                                            <span class="todo-time font-14 text-muted"><i class="icon-calender mr-1"></i><?php echo $form->DateThai($row['form_date']); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-auto">
                                                        <div class="dropdown-action">
                                                            <div class="dropdown todo-action-dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="more-action-1">
                                                                    <a class="edit dropdown-item" href="#" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['form_id']; ?>" id="btn-update"><i class="fas fa-edit text-info mr-1"></i> แก้ไข</a>
                                                                    <a class="remove dropdown-item" href="#" data-id="<?php echo $row['form_id']; ?>" id="btn-delete"><i class="far fa-trash-alt text-danger mr-1"></i> ลบ</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info text-white">
                                            <h5 class="modal-title">แก้ไข-ฟอร์ม</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form id="form-update" method="post" action="aca_form_op.php?action=u">
                ...
                <div class="modal fade" id="addFormModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content border-0">
                        <form id="form-add" class="form-horizontal" method="post" action="aca_form_op.php?action=i">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">เพิ่มข้อมูลแบบฟอร์ม</h5>
                                    ...
                                    <div class="compose-content" id="addTaskModalTitle">
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <option value="" selected>ประเภทฟอร์ม...</option>
                                                    <option value="1">คำร้องทั่วไป</option>
                                                    <option value="2">ลงทะเบียน</option>
                                                    <option value="3">การสอบ</option>
                                                    <option value="4">สถานภาพ</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="date" class="form-control" id="form-date" name="form-date" required><span class="validation-text"></span>
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="d-flex mail-to  mb-3">
                                                    <div class="w-100">
                                                        <input id="form-name" name="form-name" type="text" placeholder="ชื่อแบบฟอร์ม" class="form-control" required maxlength="200">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="d-flex mail-to mb-3">
                                                    <div class="w-100">
                                                        <input id="form-link" name="form-link" type="link" placeholder="ลิงค์แบบฟอร์ม" class="form-control" required maxlength="200">
                                                        <span class="validation-text"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex mail-subject mb-4">
                                            <div class="w-100">
                                                <div id="form-desc" class=""></div>
                                                <textarea id="form-desc-txt" name="form-desc-txt" style="display:none"></textarea>
                                                <span class="validation-text"></span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="../dist/js/aca_form.js"></script>
    ...
    <script>
        $(document).ready(function(){	
            $(document).on('click', '#btn-update', function(e){
                e.preventDefault();
                var form_id = $(this).data('id');   // it will get id of clicked row
                //console.log(form_id);
                $('#dynamic2-content').html(''); // leave it blank before ajax call
                $('#modal-loader').show();      // load ajax loader
                $.ajax({
                    url: 'aca_form_update.php',
                    type: 'POST',
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_form_op.php?action=d&form_id=" + form_id);
                        Swal.fire(
                            'Deleted!',
