<?php 
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'i') {
        ...
        //insert
        if ($news->create()) {
            header("Location: aca_news.php?msg=success");
        } else {
            header("Location: aca_news.php?msg=insert-error");
        }
    }
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'u') {
        ...
        if ($news->update()) {
            ...
            header("Location: aca_news.php?msg=update-error");
        }
    }
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'd') {
        if (isset($_GET['news_id'])) {
            ...
            if ($news->delete()) {
                ...
                header("Location: aca_news.php?msg=delete-error");
            }
        }
    }
