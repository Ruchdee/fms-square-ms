<?php 
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'i') {
        ...
        $activity->activity_owner = "S";            //Student Affairs - Ruchdee 11/12/2020
        ...
        if ($activity->create()) {
            if ($activity->activity_calendar) {
                ...
                //meduim text can't insert, fixed by inserting activity-name
                $calendar->calendar_desc = $_POST['activity-name'];
                ...
                if ($calendar->create()) {
                    header("Location: activity.php?msg=success");
                } else {
                    header("Location: activity.php?msg=insert-error");
                }
            } else {
                header("Location: activity.php?msg=success");
            }
        ...
        if (isset($_POST['activity-calendar'])) {                               //Ruchdee 01/01/2021
            ...
            if (mysqli_num_rows($result_exist) == 0) {
                ...
                if ($calendar->create()) {
                    ...
                    header("Location: activity.php?msg=update-error");
                    exit;
                }
            } else {
            ...
            if ($activity->delete()) {
                ...
                if (mysqli_num_rows($result_exist) > 0) {
                    ...
                    if ($calendar->deletebyactivity()) {
                        ...
                        header("Location: activity.php?msg=delete-error");
                        exit;
                    }
                } else {
                    header("Location: activity.php?msg=success");
