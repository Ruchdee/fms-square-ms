...
<head>
    ...
    <title>แบบสำรวจรายวิชา-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
...
<body>
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">จัดการแบบสำรวจรายวิชา</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
            ...
            <div class="email-app todo-box-container">
	            ...
	            <div class="left-part list-of-tasks">
	                ...
	                <div class="scrollable" style="height:100%;">
	                    ...
	                    <ul class="list-group">
	                        <li>
	                            <small class="p-3 grey-text text-lighten-1 db">ประเภทแบบสำรวจ</small>
	                        </li>
	                    ...
	                    <div class="todo-listing">
                            ...
                            <?php if (mysqli_num_rows($result) > 0) { ?>
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <?php 
                                        ...
                                        if ($row['survey_status']) {
                                            $istatus = "mdi-check-circle";
                                        } else {
                                            $istatus = "mdi-eye-off";
                                        }
                                    ?>
                                    <div class="todo-item all-news-list p-3 border-bottom position-relative <?php echo $row['survey_id']; ?>">
                                        <div class="inner-item d-flex align-items-start">
                                            <div class="w-100">
                                                <div class="custom-control d-flex align-items-start">
                                                    <div>
                                                        <div class="content-todo">
                                                            <h5 class="font-medium font-16 todo-header mb-0" data-todo-header="<?php echo $row['survey_title']; ?>"><?php echo $row['survey_title']; ?> <i class="mdi <?php echo $istatus; ?>"></i></h5>
                                                            <div class="todo-subtext text-muted" 
                                                                data-todosubtext-html="<?php echo substr(htmlspecialchars(trim(strip_tags($row['survey_desc']))), 0, 500); ?>" data-todosubtextText="">
                                                                <?php 
                                                                    //echo trim($row['news_desc']);
                                                                    if (strlen(trim($row['survey_desc'])) > 500) {
                                                                        echo substr(htmlspecialchars(trim(strip_tags($row['survey_desc']))), 0, 500) . "...";
                                                                    } else {
                                                                        echo trim($row['survey_desc']);
                                                                    }
                                                                ?>
                                                            </div>
                                                            <span class="todo-time font-14 text-muted"><i class="icon-calender mr-1"></i><?php echo $survey->DateThai($row['survey_deadline']); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-auto">
                                                        <div class="dropdown-action">
                                                            <div class="dropdown todo-action-dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="more-action-1">
                                                                    <a class="edit dropdown-item" href="#" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['survey_id']; ?>" id="btn-update"><i class="fas fa-edit text-info mr-1"></i> แก้ไข</a>
                                                                    <a class="remove dropdown-item" href="#" data-id="<?php echo $row['survey_id']; ?>" id="btn-delete"><i class="far fa-trash-alt text-danger mr-1"></i> ลบ</a>
                                                                    <a class="list dropdown-item" href="#" data-toggle="modal" data-target="#listModal"data-id="<?php echo $row['survey_id']; ?>" id="btn-list"><i class="far fa-list-alt text-success mr-1"></i> แสดงรายชื่อ</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info text-white">
                                            <h5 class="modal-title">แก้ไข-แบบสำรวจรายวิชา</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form id="form-update" method="post" action="aca_course_survey_op.php?action=u">
                            ...
                            <div class="modal fade" id="listModal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info text-white">
                                            <h5 class="modal-title">ข้อมูลการตอบแบบสำรวจรายวิชา</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                ...
                <div class="modal fade" id="addFormModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content border-0">
                        <form id="form-add" class="form-horizontal" method="post" action="aca_course_survey_op.php?action=i">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">เพิ่มข้อมูลแบบสำรวจรายวิชา</h5>
                                ...
                                <div class="compose-box">
                                    <div class="compose-content" id="addTaskModalTitle">
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <div class="d-flex mail-to">
                                                    <div class="w-100">
                                                        <input id="survey-title" name="survey-title" type="text" placeholder="หัวข้อแบบสำรวจ" class="form-control" required maxlength="200">
                                                        <span class="validation-text"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="date" class="form-control" id="survey-deadline" name="survey-deadline" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="วันสิ้นสุดการสำรวจ" required><span class="validation-text"></span>
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="d-flex mail-subject mb-4">
                                            <div class="w-100">
                                                <div id="survey-desc" class=""></div>
                                                <textarea id="survey-desc-txt" name="survey-desc-txt" style="display:none"></textarea>
                                                <span class="validation-text"></span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="../dist/js/aca_course_survey.js"></script>
    ...
    <script>
        $(document).ready(function(){	
            $(document).on('click', '#btn-update', function(e){
                e.preventDefault();
                var survey_id = $(this).data('id');   // it will get id of clicked row
                $('#dynamic2-content').html(''); // leave it blank before ajax call
                $('#modal-loader').show();      // load ajax loader
                $.ajax({
                    url: 'aca_course_survey_update.php',
                    type: 'POST',
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_course_survey_op.php?action=d&survey_id=" + survey_id);
                        Swal.fire(
                            'Deleted!',
            ...
            $(document).on('click', '#btn-list', function(e){
                ...
                $.ajax({
                    url: 'aca_survey_register_list.php',
                    type: 'POST',
                    data: 'survey_id='+survey_id,
                    dataType: 'html'
                })
...
<?php
    if (isset($_GET['msg'])) {
        switch ($_GET['msg']) {
            case 'success':
                echo "<script>toastr.success('บันทึกข้อมูลเรียบร้อยแล้ว', 'สำรวจรายวิชา');</script>";
                break;
            case 'insert-error':
                echo "<script>toastr.error('เพิ่มข้อมูลผิดพลาด', 'สำรวจรายวิชา');</script>";
                break;
            case 'update-error':
                echo "<script>toastr.error('แก้ไขข้อมูลผิดพลาด', 'สำรวจรายวิชา');</script>";
                break;
            case 'delete-error': 
                echo "<script>toastr.error('ลบข้อมูลผิดพลาด', 'สำรวจรายวิชา');</script>";
                break;
        }
    }
?>