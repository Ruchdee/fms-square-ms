<?php
    ...
    //read all records
    $active = false;
    $result = $moreless->readall($active);
...
<head>
    ...
    <title>ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
...
<body>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left mailbox animated bounceInDown" aria-labelledby="2">
                                <ul class="list-style-none">
                                    ...
                                    <!-- <li>
                                        <a class="nav-link text-center link text-dark" href="aca_message_list.php"> <b>ดูข้อความทั้งหมด</b> <i class="fa fa-angle-right"></i> </a>
                                    </li> -->
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                                    ...
                                    <div class="ml-2">
                                        ...
                                        <p class=" mb-0 text-muted"><?php echo $_SESSION['staff_id']; ?></p>
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
            ...
            <div class="email-app todo-box-container">
	            ...
	            <div class="left-part list-of-tasks">
	                ...
	                <div class="scrollable" style="height:100%;">
	                    <div class="p-3">
	                        <a class="waves-effect waves-light btn btn-info d-block" href="javascript: void(0)" id="add-form"><i class="mdi mdi-plus-box font-16 mr-1"></i>เพิ่มข้อมูล</a>
	                    </div>
	                    <div class="divider"></div>
	                    <ul class="list-group">
	                        <li>
	                            <small class="p-3 grey-text text-lighten-1 db">ประเภทการลงทะเบียน</small>
	                        </li>
	                    ...
	                    <div class="todo-listing">
                            ...
                            <?php if (mysqli_num_rows($result) > 0) { ?>
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <?php 
                                        if ($row['moreless_status']) {
                                            $istatus = "mdi-check-circle";
                                        } else {
                                            $istatus = "mdi-eye-off";
                                        }
                                    ?>
                                    <div class="todo-item all-news-list p-3 border-bottom position-relative <?php echo $row['moreless_id']; ?>">
                                        <div class="inner-item d-flex align-items-start">
                                            <div class="w-100">
                                                <div class="custom-control d-flex align-items-start">
                                                    <div>
                                                        <div class="content-todo">
                                                            <h5 class="font-medium font-16 todo-header mb-0" data-todo-header="<?php echo $row['moreless_title']; ?>"><?php echo $row['moreless_title']; ?> <i class="mdi <?php echo $istatus; ?>"></i></h5>
                                                            <div class="todo-subtext text-muted" 
                                                                data-todosubtext-html="<?php echo substr(htmlspecialchars(trim(strip_tags($row['moreless_desc']))), 0, 500); ?>" data-todosubtextText="">
                                                                <?php 
                                                                    if (strlen(trim($row['moreless_desc'])) > 500) {
                                                                        echo substr(htmlspecialchars(trim(strip_tags($row['moreless_desc']))), 0, 500) . "...";
                                                                    } else {
                                                                        echo trim($row['moreless_desc']);
                                                                    }
                                                                ?>
                                                            </div>
                                                            <span class="todo-time font-14 text-muted"><i class="icon-calender mr-1"></i><?php echo $moreless->DateThai($row['moreless_deadline']); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-auto">
                                                        <div class="dropdown-action">
                                                            <div class="dropdown todo-action-dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="more-action-1">
                                                                    <a class="edit dropdown-item" href="#" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['moreless_id']; ?>" id="btn-update"><i class="fas fa-edit text-info mr-1"></i> แก้ไข</a>
                                                                    <a class="remove dropdown-item" href="#" data-id="<?php echo $row['moreless_id']; ?>" id="btn-delete"><i class="far fa-trash-alt text-danger mr-1"></i> ลบ</a>
                                                                    <a class="list dropdown-item" href="#" data-toggle="modal" data-target="#listModal"data-id="<?php echo $row['moreless_id']; ?>" id="btn-list"><i class="far fa-list-alt text-success mr-1"></i> แสดงรายชื่อ</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info text-white">
                                            <h5 class="modal-title">แก้ไข-ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form id="form-update" method="post" action="aca_register_moreless_op.php?action=u">
                            ...
                            <div class="modal fade" id="listModal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info text-white">
                                            <h5 class="modal-title">ข้อมูลลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                ...
                <!-- Add New Modal -->
                <div class="modal fade" id="addFormModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content border-0">
                        <form id="form-add" class="form-horizontal" method="post" action="aca_register_moreless_op.php?action=i">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">เพิ่มข้อมูลลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด</h5>
                                ...
                                <div class="compose-box">
                                    <div class="compose-content" id="addTaskModalTitle">
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <div class="d-flex mail-to">
                                                    <div class="w-100">
                                                        <input id="moreless-title" name="moreless-title" type="text" placeholder="หัวข้อลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด" class="form-control" required maxlength="200">
                                                        <span class="validation-text"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="date" class="form-control" id="moreless-deadline" name="moreless-deadline" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="วันสิ้นสุดการลงทะเบียน" required><span class="validation-text"></span>
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="d-flex mail-subject mb-4">
                                            <div class="w-100">
                                                <div id="moreless-desc" class=""></div>
                                                <textarea id="moreless-desc-txt" name="moreless-desc-txt" style="display:none"></textarea>
                                                <span class="validation-text"></span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="../dist/js/aca_register_moreless.js"></script>
    ...
    <script>
        $(document).ready(function(){	
            $(document).on('click', '#btn-update', function(e){
                e.preventDefault();
                var moreless_id = $(this).data('id');   // it will get id of clicked row
                $('#dynamic2-content').html(''); // leave it blank before ajax call
                $('#modal-loader').show();      // load ajax loader
                $.ajax({
                    url: 'aca_register_moreless_update.php',
                    type: 'POST',
                    data: 'moreless_id='+moreless_id,
                    dataType: 'html'
                })
                .done(function(data){
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_register_moreless_op.php?action=d&moreless_id=" + moreless_id);
                        Swal.fire(
                            'Deleted!',
            ...
            $(document).on('click', '#btn-list', function(e){
                ...
                $.ajax({
                    url: 'aca_register_moreless_list.php',
                    type: 'POST',
                    data: 'moreless_id='+moreless_id,
                    dataType: 'html'
                })
...
<?php
    if (isset($_GET['msg'])) {
        switch ($_GET['msg']) {
            case 'success':
                echo "<script>toastr.success('บันทึกข้อมูลเรียบร้อยแล้ว', 'ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด');</script>";
                break;
            case 'insert-error':
                echo "<script>toastr.error('เพิ่มข้อมูลผิดพลาด', 'ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด');</script>";
                break;
            case 'update-error':
                echo "<script>toastr.error('แก้ไขข้อมูลผิดพลาด', 'ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด');</script>";
                break;
            case 'delete-error': 
                echo "<script>toastr.error('ลบข้อมูลผิดพลาด', 'ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด');</script>";
                break;
        }
    }
?>