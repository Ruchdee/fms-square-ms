...
<head>
    ...
    <title>เข้าสู่ระบบ-Staff | FMS Student Portal</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h4 class="font-medium mb-3">FMS Staff Portal</h4>
                        ...
                        <div class="col-12">
                            <form class="form-horizontal mt-3" id="loginform" action="login_process.php" method="post">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-md" placeholder="รหัสผู้ใช้งาน" aria-label="staff-id" name="staff-id" id="staff-id" aria-describedby="basic-addon1" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon2"><i class="ti-pencil"></i></span>
                                    </div>
                                    <input type="password" class="form-control form-control-md" placeholder="รหัสผ่าน" aria-label="staff-passwd" name="staff-passwd" id="staff-passwd" aria-describedby="basic-addon1" required>
                                </div>
                                        ...
                                        if (isset($_GET['msg'])) {
                                            switch ($_GET['msg']) {
                                                case 'nodata':
                                                    ...
                                                    break;
                                                case 'staffonly': 
                                                    echo "<div class='col-xs-12'><h5 class='font-medium text-danger'>สำหรับเจ้าหน้าที่เท่านั้น</h5></div>";
                                                    break;
                                                case 'fmsonly': 
                                                    echo "<div class='col-xs-12'><h5 class='font-medium text-danger'>สำหรับเจ้าหน้าที่คณะวิทยาการจัดการเท่านั้น</h5></div>";
                                                    break;
                                                case 'incorrect':
