<?php 
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'i') {
        ...
        $stype->activity_type_owner = "E";      //Educational Services - Ruchdee 11/12/2020
        ...
        //insert
        if ($stype->create()) {
            header("Location: aca_activity_type.php?msg=success");
        } else {
            header("Location: aca_activity_type.php?msg=insert-error");
        }
    }
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'u') {
        ...
        if ($stype->update()) {
            ...
            header("Location: aca_activity_type.php?msg=update-error");
        }
    }
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'd') {
        if (isset($_GET['activity_type_id'])) {
            ...
            if ($stype->delete()) {
                ...
                header("Location: aca_activity_type.php?msg=delete-error");
            }
        }
    }
