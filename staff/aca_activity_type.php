<?php
    ...
    //read all records
    $active = false;
    $result = $stype->aca_readall($active);
...
<head>
    ...
    <title>ประเภทกิจกรรม-เจ้าหน้าที่ | FMS Student Portal</title>
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ประเภทกิจกรรม</h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">
                ...
                <div class="widget-content searchable-container list">
                    <div class="card card-body">
                        <div class="row">
                            ...
                            <div class="col-md-8 text-right d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                                <a href="javascript:void(0)" id="btn-add-contact" class="btn btn-info"><i class="mdi mdi-plus-box font-16 mr-1"></i> เพิ่มข้อมูล</a>
                            </div>
                        </div>
                    </div>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title">ประเภทกิจกรรม</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                               <form method="post" action="aca_activity_type_op.php?action=i">
                                        ...
                                        <div class="add-contact-box">
                                            <div class="add-contact-content">
                                                <div class="row form-group">
                                                    <div class="col-md-12">
                                                        <div class="">
                                                            <input type="text" id="activity-type-name" name="activity-type-name" class="form-control" placeholder="ประเภทกิจกรรม" required>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="">
                                                            <textarea id="activity-type-desc" name="activity-type-desc" class="form-control" rows="3" placeholder="คำอธิบาย"></textarea>
                                                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped search-table v-middle">
                                <thead class="header-item">
                                    <th class="text-dark font-weight-bold">ประเภทกิจกรรม</th>
                                    <th class="text-dark font-weight-bold">คำอธิบาย</th>
                                    ...
                                    <tr class="search-items">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="ml-2">
                                                    <div class="user-meta-info">
                                                        <span class="user-work" data-occupation="Web Developer"><?php echo $row['activity_type_name']; ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="usr-email-addr" data-email="adams@mail.com"><?php echo $row['activity_type_desc']; ?></span>
                                        </td>
                                        <td>
                                            <span class="usr-location" data-location="Boston, USA">
                                                <?php if ($row['activity_type_status']) {
                                                        echo "ใช้งาน";
                                                    } else { echo "ยกเลิก"; } 
                                                ?>
                                            </span>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btn">
                                                <a href="#" class="text-info" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['activity_type_id']; ?>" id="btn-update"><i class="mdi mdi-table-edit font-20"></i></a>
                                                <a href="#" class="text-danger ml-2" data-id="<?php echo $row['activity_type_id']; ?>" id="btn-delete"><i class="mdi mdi-delete font-20"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <!-- /.row -->
                    ...
                    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title">แก้ไข-ประเภทกิจกรรม</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form method="post" action="aca_activity_type_op.php?action=u">
                                    <div class="modal-body">
    ...
    <script>
        $(document).ready(function(){	
            $(document).on('click', '#btn-update', function(e){
                ...
                $.ajax({
                    url: 'aca_activity_type_update.php',
                    type: 'POST',
            ...
            $(document).on('click', '#btn-delete', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_activity_type_op.php?action=d&activity_type_id=" + stype_id);
                        Swal.fire(
                            'Deleted!',
...
<?php
    if (isset($_GET['msg'])) {
        switch ($_GET['msg']) {
            case 'success':
                echo "<script>toastr.success('บันทึกข้อมูลเรียบร้อยแล้ว', 'ประเภทกิจกรรม');</script>";
                break;
            case 'insert-error':
                echo "<script>toastr.error('เพิ่มข้อมูลผิดพลาด', 'ประเภทกิจกรรม');</script>";
                break;
            case 'update-error':
                echo "<script>toastr.error('แก้ไขข้อมูลผิดพลาด', 'ประเภทกิจกรรม');</script>";
                break;
            case 'delete-error': 
                echo "<script>toastr.error('ลบข้อมูลผิดพลาด', 'ประเภทกิจกรรม');</script>";
                break;
        }
    }
?>