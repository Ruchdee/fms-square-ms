...
<head>
	...
	<title>การเรียนการสอนออนไลน์ | FMS Student Portal</title>
	<!-- Custom CSS -->
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">การเรียนการสอนออนไลน์</h4>
                    </div>
				...
				<div class="page-content container-fluid note-has-grid">
                    <div class="tab-content bg-transparent">
                        <div id="note-full-container" class="note-has-grid row">
                            <!-- Column -->
                            <div class="col-lg-4 all-forms form-type1">
                                <div class="card">
                                    <img class="card-img-top img-responsive" src="../assets/images/online_learning_success.jpg" alt="">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center mb-3">
                                            <span><i class="ti-calendar"></i> 29 มิถุนายน 2563</span>
                                        </div>
                                        <h3 class="font-normal">How to: เรียนออนไลน์อย่างไรให้มีประสิทธิภาพ</h3>
                                        <p class="mb-0 mt-2">ในขณะที่ COVID-19 กำลังระบาด หนึ่งในกิจกรรมยอดฮิต(นอกเหนือจากการทำอาหาร และถ่าย Tik Tok) ที่ดู Productivity และเพิ่ม Value ให้กับตัวเองระหว่างที่ WFH หรือหยุดงานแล้วกักตัวอยู่ที่บ้านก็คือ การเรียนออนไลน์</p>
                                        <a href="https://coniclestory.medium.com/เรียนออนไลน์อย่างไรให้มีประสิทธิภาพ-1d357a86df59" target="_blank" class="btn btn-info btn-rounded waves-effect waves-light mt-3">รายละเอียด</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Column -->
                            ...
                            <div class="col-lg-4 all-forms form-type1">
                                <div class="card">
                                    <img class="card-img-top img-responsive" src="../assets/images/coursera.jpg" alt="">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center mb-3">
                                            <span><i class="ti-calendar"></i> 28 มิถุนายน 2563</span>
                                        </div>
                                        <h3 class="font-normal">คู่มือการสมัครเรียนและเข้าใช้งาน Coursera</h3>
                                        <p class="mb-0 mt-2">มหาวิทยาลัยสงขลานครินทร์ ร่วมกับ Coursera เปิดโอกาสให้นักศึกษา บุคลากร ทุกวิทยาเขต สามารถเพิ่มพูนความรู้จากคอร์สเรียนออนไลน์ระดับโลก ฟรีกว่า 3,800 คอร์ส</p>
                                        <a href="https://eila.psu.ac.th/document/2020/200609_psu-coursera/psu-coursera-manual.pdf" target="_blank" class="btn btn-info btn-rounded waves-effect waves-light mt-3">ดาวน์โหลด</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Column -->
                            <!-- Column -->
                            <div class="col-lg-4 all-forms form-type2">
                                <div class="card">
                                    <img class="card-img-top img-responsive" src="../assets/images/Zoom_MSTeam.jpg" alt="">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center mb-3">
                                            <span><i class="ti-calendar"></i> 19 พฤษภาคม 2563</span>
                                        </div>
                                        <h3 class="font-normal">วิธีการเข้าใช้งานโปรแกรม Zoom for Education และ Microsoft Teams สำหรับนักศึกษา</h3>
                                        <p class="mb-0 mt-2"></p>
                                        <a href="https://eila.psu.ac.th/document/2020/200319_student-manual/EILA-Zoom-MSTeams-Manual-Student.pdf" target="_blank" class="btn btn-info btn-rounded waves-effect waves-light mt-3">ดาวน์โหลด</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Column -->
                            <!-- Column -->
                            <div class="col-lg-4 all-forms form-type3">
                                <div class="card">
                                    <img class="card-img-top img-responsive" src="../assets/images/google_apps.png" alt="">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center mb-3">
                                            <span><i class="ti-calendar"></i> 19 พฤษภาคม 2563</span>
                                        </div>
                                        <h3 class="font-normal">คู่มือการใช้งานโปรแกรม Google Apps สำหรับการทำงานและกิจกรรมกลุ่มออนไลน์</h3>
                                        <p class="mb-0 mt-2">การทำงานร่วมกันด้วย Google Apps for Education</p>
                                        <a href="https://eila.psu.ac.th/document/2020/200319_student-manual/EILA_GoogleDrive_Manual.pdf" target="_blank" class="btn btn-info btn-rounded waves-effect waves-light mt-3">ดาวน์โหลด</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Column -->
                            ...
                            <div class="col-lg-4 all-forms form-type1">
                                <div class="card">
                                    <img class="card-img-top img-responsive" src="../assets/images/office_365.png" alt="">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center mb-3">
                                            <span><i class="ti-calendar"></i> 19 พฤษภาคม 2563</span>
                                        </div>
                                        <h3 class="font-normal">คู่มือการใช้งานโปรแกรม MS-Office 365 สำหรับการทำงานและกิจกรรมกลุ่มออนไลน์</h3>
                                        <p class="mb-0 mt-2">มหาวิทยาลัยสงขลานครินทร์ ให้บริการ MS Office 365 สำหรับระบบการทำงานร่วมกัน (Collaborative System) สำหรับนักศึกษาใช้งานผ่านบัญชี PSU Passport</p>
                                        <a href="https://www.cc.psu.ac.th/studentemail" target="_blank" class="btn btn-info btn-rounded waves-effect waves-light mt-3">รายละเอียด</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Column -->
                            ...
                            <div class="col-lg-4 all-forms form-type1">
                                <div class="card">
                                    <img class="card-img-top img-responsive" src="../assets/images/office_365_install.jpg" alt="">
                                    <div class="card-body">
                                        <div class="d-flex no-block align-items-center mb-3">
                                            <span><i class="ti-calendar"></i> 19 พฤษภาคม 2563</span>
                                        </div>
                                        <h3 class="font-normal">วิธีการดาวน์โหลดและติดตั้ง Office 365 ได้ฟรี!! ถูกลิขสิทธิ์</h3>
                                        <p class="mb-0 mt-2">นักศึกษา ม.อ. สามารถใช้งาน Office 365 เช่น Word, PowerPoint, Excel, Access, Publisher, One Note, One Drive, Outlook ได้ "ฟรี" ถูกลิขสิทธิ์ และไม่ผิดกฏหมายแน่นอน</p>
                                        <a href="https://www.youtube.com/watch?v=KlxGs6o9TyU" target="_blank" class="btn btn-info btn-rounded waves-effect waves-light mt-3">รายละเอียด</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Column -->
                    ...
                    <!-- Modal -->
                    <div class="modal activity-details" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <h4 class="modal-title" id="myLargeModalLabel">รายละเอียดกิจกรรม</h4>
