<?php
    ...
    $result = $calendar->readallforacyear_semester();

    $events = "[";
    while ($row = mysqli_fetch_array($result)) {
        $event_bg = ($row['calendar_owner'] == 'E') ? 'bg-info' : 'bg-warning';
        $events = $events . "{title: '" . $row['calendar_title'] . "', desc: '" . $row['calendar_desc'] . "', start: new Date('" . date_format(date_create($row['start_date']), 'm/d/Y') . " " . $row['start_time'] . "'), end: new Date('" . date_format(date_create($row['end_date']), 'm/d/Y') . " " . $row['end_time'] . "'), className: '" . $event_bg . "'}, ";
    }
    $events = $events . "]";
...
<head>
    ...
    <title>ปฏิทินการศึกษา | FMS Student Portal</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ปฏิทิน</h4>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item"><a href="../main.php">หน้าแรก</a></li>
                                <li class="breadcrumb-item active" aria-current="page">ปฏิทิน</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="page-content container-fluid">
                ...
                <!-- BEGIN MODAL -->
                <div class="modal fade none-border" id="my-event" tabindex="-1" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title event-heading text-white"></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            </div>
                            <div class="modal-body">
                                <label class="mb-0 font-16">รายละเอียด</label>
                                <p class="event-text text-muted"></p>
                            </div>
    ...
    <script src="../dist/js/pages/calendar/cal-student-init.js"></script>
    <!--Notify-->
