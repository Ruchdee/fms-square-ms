<?php
    ...
    //read all active news for a specific academic year & semester
    //$active = true;
    $news->academic_year = $row_setting['academic_year'];
    $news->semester = $row_setting['semester'];
    $result = $news->readallforacyear_semester();
...
<head>
	...
	<title>ข่าวสารและประกาศ | FMS Student Portal</title>
	<!-- Custom CSS -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a href="news_list.php" class="sidebar-link waves-effect waves-dark" aria-expanded="false">
                                ...
                                <?php 
                                    if ($news->chklatestall()) {
                                        echo "<span class='badge badge-danger badge-pill ml-auto mr-3 font-medium px-2 py-1'>update</span>"; 
                                    }
                                ?>
                            </a>
                        </li>
                    ...
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">ข่าวสารและประกาศ</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div id="note-full-container" class="note-has-grid row">
                            <?php while ($row = mysqli_fetch_array($result)) { 
                                if ($row['news_type'] == '1') {
                                    ...
                                    $ntype = "notificatin-only";
                                    $bgcolor = "lightblue";
                                }
                                if ($news->chklatest($row['news_date'])) {
                                    $msg_latest = "news-latest";
                                } else {
                                    $msg_latest = "";
                                }
                            ?>
                        
                            <div class="col-md-4 single-note-item all-news <?php echo $msg_latest; ?> <?php echo $ntype; ?>">
                                <div class="card card-body">
                                    <span class="side-stick" style="background-color:<?php echo $bgcolor; ?>"></span>
                                    <h5 class="note-title text-truncate w-75 mb-2" data-noteHeading=""><?php echo $row['news_title']; ?></h5>
                                    <p class="note-date font-14 text-muted"><?php echo $news->DateThai($row['news_date']); ?></p>
                                    <div class="note-content">
                                        <p class="note-inner-content text-muted" data-noteContent=""><?php echo substr(htmlspecialchars(trim(strip_tags($row['news_desc']))), 0, 500); ?></p>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-warning" data-toggle="modal" data-target="#showDescModal" data-id="<?php echo $row['news_id']; ?>" id="btn-desc">รายละเอียด</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">รายละเอียดข่าวสารและประกาศ</h5>
