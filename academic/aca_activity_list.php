<?php
    ...
    $result = $activity->aca_readforacyear();
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ข้อมูลกิจกรรมวิชาการ</h4>
                    </div>
        ...
        $(document).ready(function(){	
            $(document).on('click', '#btn-register', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_activity_register_op.php?action=i&activity_id=" + activity_id);
                        Swal.fire(
                            'Registered!',
            ...
            $(document).on('click', '#btn-unregister', function(e){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $(location).attr("href", "aca_activity_register_op.php?action=d&activity_id=" + activity_id);
                        Swal.fire(
                            'Unregistered!',
