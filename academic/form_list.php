<?php
    ...
    //read all active forms info
    $active = true;
    $result = $form->readall($active);

    //form type
    $ftype = array("1"=>"คำร้องทั่วไป", "2"=>"ลงทะเบียน", "3"=>"การสอบ", "4"=>"สถานภาพ");
    //$ftype = array("1"=>"General", "2"=>"Registration", "3"=>"Exam", "4"=>"Status");
...
<head>
	...
	<title>ดาวน์โหลดแบบฟอร์ม | FMS Student Portal</title>
	<!-- Custom CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">ดาวน์โหลดแบบฟอร์ม</h4>
                    </div>
            ...
            <div class="page-content container-fluid note-has-grid">
                <ul class="nav nav-pills p-3 bg-white mb-3 rounded-pill align-items-center">
                    <li class="nav-item"><a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center active px-2 px-md-3 mr-0 mr-md-2" id="all-forms">
                        <i class="icon-layers mr-1"></i><span class="d-none d-md-block">ทั้งหมด</span></a> 
                    </li>
                    <?php foreach($ftype as $ftype_id => $ftype_value) { ?>
                        <li class="nav-item"><a href="javascript:void(0)" class="nav-link rounded-pill note-link d-flex align-items-center px-2 px-md-3 mr-0 mr-md-2" id="<?php echo $ftype_id; ?>"> 
                            <i class="icon-note mr-1"></i> <?php echo $ftype_value; ?><span class="d-none d-md-block"></span></a> 
                        </li>
                    <?php } ?>
                </ul>
                <div class="tab-content bg-transparent">
                    <div id="note-full-container" class="note-has-grid row">
                        <?php while ($row = mysqli_fetch_array($result)) { ?>
                            <div class="col-md-4 single-note-item all-forms <?php echo $row['form_type']; ?>">
                                <div class="card">
                                    <div class="card-body">
                                        <span class="side-stick bg-warning"></span>
                                        <h5 class="note-title mb-2"><strong><?php echo $row['form_name']; ?></strong></h5>
                                        <p class="note-date font-14 text-muted"><i class="ti-calendar"></i> <?php echo $form->DateThai($row['form_date']); ?></p>
                                        <div class="note-content">
                                            <p class="note-inner-content text-muted" data-noteContent=""><?php echo substr(htmlspecialchars(trim(strip_tags($row['form_desc']))), 0, 500); ?></p>
                                        </div>
                                        <a href="<?php echo $row['form_link']; ?>" class="btn btn-info btn-rounded" target="_blank"><i class="mdi mdi-download"></i> ดาวน์โหลด</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
