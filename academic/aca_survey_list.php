...
<head>
	...
	<title>สำรวจรายวิชา | FMS Student Portal</title>
	<!-- Custom CSS -->
...
<body>
	...
	<div id="main-wrapper">
		...
		<div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h4 class="font-medium text-uppercase mb-0">สำรวจรายวิชา</h4>
                    </div>
                            ...
                            <table id="alt_pagination" class="table table-striped display" style="width:100%">
                                ...
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    ...
                                    <tr class="search-items">
                                        <td>
                                            <div class="d-flex text-left"><?php echo $survey->DateThai(date_format(date_create($row['created_date']), 'm/d/Y')); ?></div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center"><?php echo $survey->DateThai(date_format(date_create($row['survey_deadline']), 'm/d/Y')); ?>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <a class="text-primary" href="#" data-toggle="modal" title="รายละเอียดแบบสำรวจ" data-target="#showDescModal" data-id="<?php echo $row['survey_id']; ?>" id="btn-desc"><i class="fa fa-external-link-alt font-18"></i></a>
                                            &nbsp;&nbsp;&nbsp;
                                            <?php
                                                if ($survey->chkExpired($row['survey_deadline'])) {
                                                    echo "<span class='text-danger'><i class='fa fa-bell-slash font-18'></i></span>";
                                                } else {
                                                    echo "<a class='text-info' href='#' data-toggle='modal' title='ทำแบบสำรวจ' data-target='#doSurveyModal' data-id='" . $row['survey_id'] . "' id='btn-survey'><i class='fa fa-edit font-18'></i></a>";
                                                }
                                            ?>
                                        </td>
                                    </tr>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-info text-white">
                            <h5 class="modal-title">รายละเอียดแบบสำรวจรายวิชา</h5>
            ...
            <!-- Add New Modal -->
            <div class="modal fade" id="doSurveyModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content border-0">
                        <form id="form-add" class="form-horizontal" method="post" action="aca_survey_register_op.php">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">สำรวจรายวิชา</h5>
