...
<head>
	...
	<title>ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด | FMS Student Portal</title>
	<!-- Custom CSS -->
...
<body>
	...
	<div id="main-wrapper">
		...
		<div class="page-wrapper">
                    ...
                    <div class="card card-body">
                        <div class="row">
                            <div class="col-md-12 text-right d-flex justify-content-center mt-3 mt-md-0">
                                <a href="../assets/notice/regisfms62.pdf" class="btn btn-success" target="_blank"> ประกาศคณะวิทยาการจัดการ</a>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="alt_pagination" class="table table-striped display" style="width:100%">
                                <thead class="header-item">
                                    ...
                                    <th class="text-dark font-weight-bold">หัวข้อ</th>
                                    <th class="text-dark font-weight-bold">วันสิ้นสุด</th>
                                ...
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    ...
                                    <tr class="search-items">
                                        <td><?php echo $row['moreless_id']; ?></td>
                                        <td>
                                            <div class="d-flex text-left"><?php echo $moreless->DateThai(date_format(date_create($row['created_date']), 'm/d/Y')); ?></div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                            <?php echo $row['moreless_title']; ?>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center"><?php echo $moreless->DateThai(date_format(date_create($row['moreless_deadline']), 'm/d/Y')); ?>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <a class="text-primary" href="#" data-toggle="modal" title="รายละเอียดการลงทะเบียน" data-target="#showDescModal" data-id="<?php echo $row['moreless_id']; ?>" id="btn-desc"><i class="fa fa-external-link-alt font-18"></i></a>
                                            &nbsp;&nbsp;&nbsp;
                                            <?php
                                                if ($moreless->chkExpired($row['moreless_deadline'])) {
                                                    echo "<span class='text-danger'><i class='fa fa-bell-slash font-18'></i></span>";
                                                } else {
                                                    echo "<a class='text-info' href='#' data-toggle='modal' title='ลงทะเบียน' data-target='#doRegisterModal' data-id='" . $row['moreless_id'] . "' id='btn-register'><i class='fa fa-edit font-18'></i></a>";
                                                }
                                            ?>
                                        </td>
                                    </tr>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-info text-white">
                            <h5 class="modal-title">รายละเอียดลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด</h5>
            ...
            <!-- Add New Modal -->
            <div class="modal fade" id="doRegisterModal" tabindex="-1" role="dialog" aria-labelledby="addTaskModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content border-0">
                        <form id="form-add" class="form-horizontal" method="post" action="aca_moreless_op.php">
                            <div class="modal-header bg-info text-white">
                                <h5 class="modal-title">ลงทะเบียนหน่วยกิตเกิน/น้อยกว่ากำหนด</h5>
                                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body text-center">
                                <div id="modal3-loader" class="spinner-border text-success" role="status">
                                    <span class="sr-only">Loading...</span>
                                </div>
                                <!-- content will be load here -->     
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-info add-tsk"> บันทึกข้อมูล</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#btn-register', function(e){
                ...
                $('#modal3-loader').show();      // load ajax loader
                $.ajax({
                    url: 'aca_moreless_request.php',
                    type: 'POST',
                    data: 'moreless_id='+moreless_id,
                    dataType: 'html'
                })
                .done(function(data){
                    ...
                    $('#modal3-loader').hide();		  // hide ajax loader	
                })
                .fail(function(){
